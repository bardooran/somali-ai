"""Score the frozen preselected C2A 3sg-feminine-past benchmark v19.

The two target surfaces are lemma-specific dictionary attestations. Because C2A
2SG and 3SG feminine are documented as syncretic in this past cell, v19
separates surface recognition from 3SG-feminine person resolution and reports
whether both person analyses are preserved after any future generic activation.
...
BENCHMARK_PATH = Path("data/qa/morphology_paradigm_benchmark_v19.jsonl")
METADATA_PATH = Path("data/qa/morphology_paradigm_benchmark_v19.meta.json")
SELECTED_TARGETS = ("caafi", "bushi")
EXPECTED_SYNCRETIC_PERSONS = {"2sg", "3sg_f"}
...
def report() -> dict:
    ...
    return {
        ...
        "preauthorization": {
            ...
            "generic_3sg_feminine_past_authorized_at_freeze": False,
        ...
        "combined": {
            ...
            "syncretism_diagnostics": {
                ...
                "surface_has_2sg_analysis_count": len(has_2sg),
                "surface_has_3sg_f_analysis_count": len(has_3sg_f),
