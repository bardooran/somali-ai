"""Score the frozen preselected C2A 1pl-past benchmark v16.

v16 scores only the independently attested `buubinnay` row. `bushi` and
`butaaci` remain unresolved and are deliberately excluded rather than inferred.
...
BENCHMARK_PATH = Path("data/qa/morphology_paradigm_benchmark_v16.jsonl")
METADATA_PATH = Path("data/qa/morphology_paradigm_benchmark_v16.meta.json")
SELECTED_TARGETS = ("bushi", "butaaci", "buubi")
...
def report() -> dict:
    ...
    return {
        ...
        "preauthorization": {
            ...
            "generic_1pl_past_authorized_at_freeze": False,
