"""Score the frozen preselected C2A 2sg-past benchmark v15.

v15 scores only the independently attested `buuxisay` row. `caajisi` remains
unresolved and is deliberately excluded rather than inferred. Benchmark answers
...
BENCHMARK_PATH = Path("data/qa/morphology_paradigm_benchmark_v15.jsonl")
METADATA_PATH = Path("data/qa/morphology_paradigm_benchmark_v15.meta.json")
SELECTED_TARGETS = ("buuxi", "caajisi")
...
def report() -> dict:
    ...
    return {
        ...
        "preauthorization": {
            ...
            "generic_2sg_past_authorized_at_freeze": False,
