"""Score the frozen preselected C2A 1sg-past benchmark v17.

v17 scores only independently attested, person-resolved `aaddiyay` and
`buufiyay`. `afceli` remains unresolved and is deliberately excluded rather
than inferred. Benchmark answers remain evaluation-only.
"""
...
BENCHMARK_PATH = Path("data/qa/morphology_paradigm_benchmark_v17.jsonl")
METADATA_PATH = Path("data/qa/morphology_paradigm_benchmark_v17.meta.json")
SELECTED_TARGETS = ("aaddi", "afceli", "buufi")
...
def report() -> dict:
    ...
    return {
        ...
        "preauthorization": {
            ...
            "generic_1sg_past_authorized_at_freeze": False,
