"""Score the frozen preselected C2A 2pl-past benchmark v14.

v14 scores only the independently attested `buufiseen` row.  `caafi` remains
...
def report() -> dict:
    ...
    return {
        ...
        "preauthorization": {
            ...
            "generic_2pl_past_authorized_at_freeze": False,
